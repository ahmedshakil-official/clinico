    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('prescription_number', models.CharField(blank=True, db_index=True, max_length=100, unique=True)),
                ('diagnosis', models.TextField(blank=True, null=True)),
                ('medicines', models.TextField(help_text='Write medicines and dosage instructions')),
                ('advice', models.TextField(blank=True, null=True)),
                ('notes', models.TextField(blank=True, null=True)),
                ('is_removed', models.BooleanField(default=False)),
                ('appointment', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='prescriptions', to='appointment.appointment', verbose_name='Appointment')),
